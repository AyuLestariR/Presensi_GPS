...
app.post('/employee/create', async (req, res) => {
    ...
    try {
        ...
        data:{
            nama: 'Riska', nik:'6547659', alamat: 'Bandung', no_hp: '085740781307', email: 'riskaptriii226@gmail.com', password:hashSync('admin4', salt), jenis_kelamin:'Wanita', roletype:'Admin', in_active:'True',
        },
        });
        res.json(Employee);
    }catch (error) {
